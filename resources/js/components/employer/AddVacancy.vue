...
<div class="block">
        <div class="block-header">
            <h3 class="block-title">Добавление вакансии</h3>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            editor: ClassicEditor,
                editorData: '<p>Описание вакансии</p>',
                editorConfig: {
    ...
    methods: {
        ...
        save(){
            ...
            axios.post('/api/employer/vacancy/create', {title: this.title, user_id: this.user_id, image: this.image, videointerview: this.videointerview, quiz: this.quiz, content:this.editorData}
                ).then(res => {                    
                    loader.hide()
